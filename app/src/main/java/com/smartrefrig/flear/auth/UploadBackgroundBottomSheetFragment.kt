 ...
 *
 */
class UploadBackgroundBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        try {
            mBottomSheetListener = context as UploadBackgroundBottomSheetFragment.BottomSheetListener?
        }catch (e : Exception){
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode == REQUEST_TAKE_PHOTO && resultCode == AppCompatActivity.RESULT_OK) {
            try {
                ...
                firebaseManager.uploadBackground(context!!,filePath!!)
                dismiss()
            } catch (e: IOException) {
                e.printStackTrace()
            }
