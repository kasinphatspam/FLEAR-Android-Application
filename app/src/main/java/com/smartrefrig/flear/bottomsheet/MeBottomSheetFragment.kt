 ...
 *
 */
class MeBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val v = inflater.inflate(R.layout.fragment_me_bottom_sheet, container, false)
        ...
        setOnClickListener(deleteConstraintLayout,key)
    ...
    private fun setOnClickListener(deleteConstraintLayout: ConstraintLayout, key: String)
    {
